...
namespace Cartography.Runtime
{
	public class PropertyMappingRequest
	{
		...
		{
			return new PropertyMappingRequest(ownerType, new SingleProperty(sourceProperty),
			                                  new SingleProperty(destinationProperty));
		}

		public override string ToString()
		{
			return "Property Request: {0}.{1} to {2}.{3}".ToFormat(OwnerType.Name, Source.Name, Destination.OwnerType.Name,
			                                                       Destination.Name);
		}
	}
}